...
(function() {
                ...
                return function dirPaginationLinkFn(scope, element, attrs){
                    ...
                    if (typeof attrs.totalItems !== 'undefined') {
                        ...
                        scope.$watch(function() {
                        	//alert('attrs.totalItems' + $parse(attrs.totalItems)(scope));
                        ...
                        scope.$watchCollection(function() {
                        	//alert('watchCollection');
                            return collectionGetter(scope);
                        }, function(collection) {
                            if (collection) {
                            	//alert('collectioncollection' + JSON.stringify(collection));
    ...
    module.directive('dirPaginationControls', ['paginationService', 'paginationTemplate', function(paginationService, paginationTemplate) {
        ...
        function generatePagesArray(currentPage, collectionLength, rowsPerPage, paginationRange) {
            ...
            var position;
            //alert(currentPage + ' ' + collectionLength + ' ' + rowsPerPage + ' ' + paginationRange);
